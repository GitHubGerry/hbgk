		...
		success:function(data){
			...
			$("#mydatagrid").datagrid({
				...
				columns:[[
							...
							{ title: '平均利润百分率', field:'averageprofitpercent', width: 115, halign:'center', align: 'center'},
							{ title: '最近利润百分率', field:'lastprofitpercent', width: 115, halign:'center', align: 'center'},
							
							{ title: '操作', field:'operate', width: 210, halign:'center', align: 'center',formatter:operate}
							]],
				frozenColumns: [[{ title:'供应商编号',field: 'buyerid', width:165,align: 'center',sortable:'true'}]]
...
function check1(){
	...
	if(err!=''){
		...
		insertdo(buyerid,companyname,linkman1,tele1,linkman2,tele2,wechat);
	}
}

function insertdo(buyerid,companyname,linkman1,tele1,linkman2,tele2,wechat){
	var url="insertBuyer?buyerid="+buyerid+"&companyname="+companyname+"&linkman1="+linkman1+"&tele1="+tele1+"&linkman2="+linkman2;
...
function editdo(){
	...
	if(flag==2){
		var url='updateBuyer?buyerid='+$("#buyerid2").textbox("getValue")+'&companyname='+$("#companyname2").textbox("getValue");
